...
void Curvature::computePrincipal( Mesh * mesh )
{
...
void Curvature::computeCurvatures(Mesh * mesh)
{
	printf("Computing curvatures (2nd method).."); CreateTimer(timer);

	computePointAreas(mesh);
...
void Curvature::computeDerivativesCurvatures(Mesh * mesh)
{
...
void Curvature::computePointAreas(Mesh * mesh)
{
