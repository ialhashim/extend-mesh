...
struct Color4 {
	...
	inline float r(){ return (float) m_v[0] / 255.0; }
	inline float g(){ return (float) m_v[1] / 255.0; }
	inline float b(){ return (float) m_v[2] / 255.0; }
	inline float a(){ return (float) m_v[3] / 255.0; }
